...
Дашборды выбирают полный календарный месяц (по умолчанию сентябрь 2026).
Флаг сравнения показывает предыдущий полный месяц; график выравнивается по номеру
дня, каждая линия заканчивается в последний день своего месяца (28/29/30/31).
...
считаются на конец периода по всей истории, а не только по документам диапазона.
